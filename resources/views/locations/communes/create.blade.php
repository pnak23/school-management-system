...
<div class="py-6">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Header -->
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-900">Create Commune</h1>
            <p class="text-gray-600 mt-1">Add a new commune to the system</p>
        </div>
                ...
                <div class="mb-5">
                    ...
                    <select name="district_id" 
                        ...
                        @foreach($districts as $district)
                            <option value="{{ $district->id }}" data-province="{{ $district->province_id }}" {{ old('district_id') == $district->id ? 'selected' : '' }}>
                                {{ $district->name_en }}
                            </option>
                        @endforeach
                    </select>
